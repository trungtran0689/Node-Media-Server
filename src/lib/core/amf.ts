...
export function amfType(o: any): string {
 ...
 */
export function amf3decUndefined(): any {
 ...
 */
export function amf3decNull(): any {
 ...
 */
export function amf3decFalse(): any {
 ...
 * @returns {{len: number, value: boolean}}
 */
export function amf3decTrue(): any {
...
export function amf3decString(buf) {
  ...
  sLen >>= 1; // The real length without the lowest bit
  if (s) {
    return {
      len: sLen.value + 5,
 ...
 * @param buf
 */
export function amf3decObject(buf: Buffer): any {
  const obj = {};
  const _pos = 0;
 ...
 * AMF0 Encode Object
 */
export function amf0encObject(o): undefined | Buffer {
  if (typeof o !== 'object') {
    return undefined;
  }
